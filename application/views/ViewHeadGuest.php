                ...
                <div class="navbar-collapse" id="navbar-mobile">
                    ...
                    <ul class="nav navbar-nav float-right">
                        ...
                        <li class="dropdown dropdown-user nav-item"><a class="dropdown-toggle nav-link dropdown-user-link" href="#" data-toggle="dropdown">
                                <div class="user-nav d-sm-flex d-none"><span class="user-name text-bold-600"><?php echo $this->session->userdata('nama_user'); ?></span><span class="user-status">Guest</span></div><span><img class="round" src="<?php echo base_url();?>assets/images/<?php echo $this->session->userdata('photo'); ?>" alt="avatar" height="40" width="40"></span>
                            </a>
                            <div class="dropdown-menu dropdown-menu-right">
                                <div class="dropdown-divider"></div><a class="dropdown-item" href="<?php echo base_url();?>Guest/logout"><i class="feather icon-power"></i> Logout</a>
                            </div>
                        </li>
                    </ul>
                </div>
    ...
    <div class="main-menu menu-fixed menu-light menu-accordion menu-shadow" data-scroll-to-active="true">
        ...
        <div class="main-menu-content">
            <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
                <li class="active nav-item"><a href="<?php echo base_url();?>Guest"><i class="feather icon-home"></i><span class="menu-title" data-i18n="Dashboard">Beranda</span></a>
                </li>
                <li class=" navigation-header"><span>Menu</span>
                </li>
                
                <li class=" nav-item"><a href="<?php echo base_url();?>Guest/server"><i class="fa fa-desktop"></i><span class="menu-title" data-i18n="Email">Server</span></a>
                </li>
                <li class=" nav-item"><a href="<?php echo base_url();?>Guest/vps"><i class="fa fa-server"></i><span class="menu-title" data-i18n="Email">VPS</span></a>
                </li>
                <li class=" nav-item"><a href="<?php echo base_url();?>Guest/sistem"><i class="fa fa-dot-circle-o"></i><span class="menu-title" data-i18n="Email">Sistem</span></a>
                </li>

                <li class=" navigation-header"><span>Akun</span>
                </li>
                
                <li class=" nav-item"><a href="<?php echo base_url();?>Guest/logout"><i class="feather icon-log-out"></i><span class="menu-title">Logout</span></a>
                </li>
