                ...
                <div class="navbar-collapse" id="navbar-mobile">
                    <div class="mr-auto float-left bookmark-wrapper d-flex align-items-center">
                        ...
                        <ul class="nav navbar-nav bookmark-icons">
                            ...
                            <li class="nav-item d-none d-lg-block"><a class="nav-link" href="" data-toggle="tooltip" data-placement="top" title="Todo"><i></i>Selamat Datang</a></li>
    ...
    <div class="main-menu menu-fixed menu-light menu-accordion menu-shadow" data-scroll-to-active="true">
        ...
        <div class="main-menu-content">
            <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
                <li class="active nav-item"><a href="<?php echo base_url();?>Teknisi"><i class="feather icon-home"></i><span class="menu-title" data-i18n="Dashboard">Beranda</span></a>
                </li>
                ...
                <li class=" nav-item"><a href="#"><i class="feather icon-cpu"></i><span class="menu-title" data-i18n="Components">Komponen</span></a>
                    <ul class="menu-content">
                        <li><a href="<?php echo base_url();?>Teknisi/prosesor"><i class="fa fa-cogs"></i><span class="menu-item">Prosesor</span></a>
                        </li>
                        <li><a href="<?php echo base_url();?>Teknisi/ram"><i class="fa fa-cogs"></i><span class="menu-item">RAM</span></a>
                        </li>
                        <li><a href="<?php echo base_url();?>Teknisi/storage"><i class="fa fa-cogs"></i><span class="menu-item">Storage</span></a>
                        </li>
                        <li><a href="<?php echo base_url();?>Teknisi/kabel"><i class="fa fa-cogs"></i><span class="menu-item">Kabel</span></a>
                        </li>
                        
                    </ul>
                </li>
                <li class=" nav-item"><a href="<?php echo base_url();?>Teknisi/ruangan"><i class="fas fa-door-closed"></i><span class="menu-title" data-i18n="Email">Ruangan</span></a>
                </li>
                <li class=" nav-item"><a href="<?php echo base_url();?>Teknisi/lemari"><i class="fa fa-building"></i><span class="menu-title" data-i18n="Email">Lemari</span></a>
                </li>
                <li class=" nav-item"><a href="<?php echo base_url();?>Teknisi/rak"><i class="feather icon-inbox"></i><span class="menu-title" data-i18n="Email">Rak</span></a>
                </li>
                <li class=" nav-item"><a href="<?php echo base_url();?>Teknisi/server"><i class="fa fa-desktop"></i><span class="menu-title" data-i18n="Email">Server</span></a>
                </li>
                <li class=" nav-item"><a href="<?php echo base_url();?>Teknisi/vps"><i class="fa fa-server"></i><span class="menu-title" data-i18n="Email">VPS</span></a>
                </li>
                <li class=" nav-item"><a href="<?php echo base_url();?>Teknisi/sistem"><i class="fa fa-dot-circle-o"></i><span class="menu-title" data-i18n="Email">Sistem</span></a>
                </li>
                <li class=" nav-item"><a href="<?php echo base_url();?>Teknisi/laporan"><i class="fa fa-paperclip "></i><span class="menu-title" data-i18n="Email">Laporan</span></a>
                </li>

                <li class=" navigation-header"><span>Akun</span>
                </li>
                <li class=" nav-item"><a href="<?php echo base_url();?>Teknisi/ubahdataakun"><i class="feather icon-settings"></i><span class="menu-title">Ubah Data Akun</span></a>
                </li>
                <li class=" nav-item"><a href="<?php echo base_url();?>Teknisi/logout"><i class="feather icon-log-out"></i><span class="menu-title">Logout</span></a>
                </li>
