	...
	<div id="header" class="not-sticky">
		<div class="container">
			...
			<div class="left-side">
				...
				<!-- Logo -->
				<div id="logo">
					<a href="<?php echo base_url();?>pengembang/beranda"><img src="<?php echo base_url();?>assets/images/<?php echo $baris->logo_web; ?>" alt=""></a>
					<a href="<?php echo base_url();?>pengembang/beranda" class="dashboard-logo"><img src="<?php echo base_url();?>assets/images/logopbgdev2.png" alt=""></a>
				</div>
	...
	<div class="dashboard-nav">
		<div class="dashboard-nav-inner">
			...
			<ul data-submenu-title="Utama">
				<li class="<?php if($this->uri->segment('1')=="pengembang" and $this->uri->segment('2')=="beranda"){echo 'active';}?>"><a href="<?php echo base_url();?>pengembang/beranda"><i class="sl sl-icon-settings"></i> Beranda</a></li>
				<li class="<?php if($this->uri->segment('1')=="pengembang" and $this->uri->segment('2')=="tambahfoto"){echo 'active';}?>"><a href="<?php echo base_url();?>pengembang/tambahfoto"><i class="sl sl-icon-picture "></i> Tambah Foto Proyek</a></li>
				<li class="<?php if($this->uri->segment('1')=="pengembang" and $this->uri->segment('2')=="dataproyek"){echo 'active';}?>"><a href="<?php echo base_url();?>pengembang/dataproyek"><i class="sl sl-icon-briefcase"></i> Data Proyek </a></li>
				
			</ul>
			

			<ul data-submenu-title="Akun">
				<li class="<?php if($this->uri->segment('1')=="pengembang" and $this->uri->segment('2')=="akun"){echo 'active';}?>"><a href="<?php echo base_url();?>pengembang/akun"><i class="sl sl-icon-user"></i> Akunku</a></li>
				<li><a href="<?php echo base_url();?>pengembang/keluar"><i class="sl sl-icon-power"></i> Keluar</a></li>
			</ul>
