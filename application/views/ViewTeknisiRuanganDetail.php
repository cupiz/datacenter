                    ...
                    <div class="col-12">
                        ...
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                ...
                                ?>
                                <li class="breadcrumb-item active"><?php echo $baris->nama_ruangan; ?>
                                </li>
                            </ol>
                        </div>
                    </div>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">Detail <?php echo $baris->nama_ruangan; ?></h4>
                            </div>
                                ...
                                <div class="card-body card-dashboard">
                                    ...
                                    <div class="card-text">
                                        <dl class="row">
                                            ...
                                            <dd class="col-sm-9"><?php echo $baris->nama_ruangan; ?></dd>
                                        </dl>
                                        <?php } ?>
                                        <dl class="row">
                                            <dt class="col-sm-3">Jumlah Lemari</dt>
                                            <dd class="col-sm-9">
                                            <?php
                                        ...
                                        <dl class="row">
                                            <dt class="col-sm-3">Jumlah Rack</dt>
                                            <dd class="col-sm-9">
                                            <?php
