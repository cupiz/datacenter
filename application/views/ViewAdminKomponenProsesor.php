                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title">Data Prosesor</h4>
                                </div>
                                <div class="card-content">
                                    <div class="card-body card-dashboard">
                                        <a class="badge badge-pill badge-lg badge-primary badge-glow" href="<?php echo base_url();?>Admin/tambahprosesor">Tambah Data</a>
                                    ...
                                    <td>
                                        <?php if($baris->status_prosesor == 'RUSAK'){
                                            echo '<div class="chip chip-danger">';
                                        }else if($baris->status_prosesor == 'GANTI'){
                                        ...
                                        ?>
                                            ...
                                            <div class="chip-body">
                                                ...
                                                <?php echo $baris->status_prosesor; ?>
                                    ...
                                    <td>
                                                            <a class="badge badge-pill badge-info badge-glow" href="<?php echo base_url();?>Admin/ubahprosesor/<?php echo $baris->id_prosesor; ?>">Ubah</a>
