                        ...
                        <table class="table data-list-view">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                    <?php echo $baris->ukuran_storage; ?> GB
                                    </td>
                                    <td>
                                    ...
                                    <td>
                                        <div class="chip chip-info">
                                            <div class="chip-body">
                                                <div class="chip-text"><a style="color:white" href="<?php echo base_url();?>Teknisi/detailstorage/<?php echo $baris->id_storage; ?>">DETAIL</a></div>
                                            </div>
                                        </div>
                                    </td>
                                </tr>
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title">History Storage</h4>
                                </div>
